...
class Pooled_Dataset(Dataset):
    ...
    eval: evaluation errors
        ...
        df = pd.read_csv('./data/hydrology/SSC_pooled.csv', index_col=0) # 将第一列作为索引        
        ...
        path = "./data/hydrology/pooled_meanstd.pk"
...
def get_dataloader_pooled(batch_size, device, seed=1, val_len=0.1, num_workers=4, 
    ...
    eval_missing_pattern = missing_pattern
    train_missing_pattern = target_strategy
...
if __name__ == "__main__":
    ...
    data_path = './data/hydrology/SSC_pooled.csv'
