...
# based on the mask, replace the x with the predicted x_hat
    ...
    def forward(self, x, mask, u=None, return_hidden=False):
        ...
        for s in range(steps - 1):
            ...
            x_t = self._preprocess_input(x[:, s], x_hat, mask[:, s], u_t) # [64,40]
    ...
    def add_model_specific_args(parser):
        parser.add_argument('--d-in', type=int, default = 20)
