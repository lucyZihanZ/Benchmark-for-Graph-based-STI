...
from dataset_ssc import get_dataloader_original, get_dataloader
from vae_model_ssc import VAE_ssc
from utils_vae_ssc import train_vae, evaluate_vae

from main_model import CSDI_ssc
...
foldername = (
    "./save/ssc_validationindex" + str(args.validationindex) + "_" + current_time + "/"
)
...
model_vae = VAE_ssc(config, args.device).to(args.device)
...
if __name__ == '__main__':
    ...
    model = CSDI_ssc(config, args.device).to(args.device)
