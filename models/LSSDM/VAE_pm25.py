...
class VAE(nn.Module):
    def __init__(self, config, inputdim=1):
        ...
        self.input_projection_u = Conv1d_with_init(36*36, 16, 1)
        self.input_projection_sigma = Conv1d_with_init(36*36, 16, 1)
        self.trans = nn.Linear(16,36*36)
##################################################################################
    ...
    def forward(self, x, cond_info):
        ...
        # for air36
        adj = np.load('AQI_small_adj.npz')['adj']
